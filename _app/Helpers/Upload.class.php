...
class Upload {
    ...
    function __construct($BaseDir = null) {
        ...
        self::$BaseDir = ( (string) $BaseDir ? $BaseDir : UPLOAD_DIR);
    ...
    /**
     * <b>Enviar Media:</b> Basta envelopar um $_FILES de uma mídia e caso queira um nome e um tamanho personalizado.
